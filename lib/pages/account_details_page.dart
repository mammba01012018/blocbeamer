            ...
            padding: const EdgeInsets.all(20.0),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(name, style: new TextStyle(fontWeight: FontWeight.w500 , fontSize: 20.0),),
                  const SizedBox(height: 30.0),
                  ...
                  Row(
                    ...
                    children:<Widget> [
                      RaisedButton(
                        ...
                        child: new Text(
                          'Update Member'  , style: TextStyle(color: Colors.white, fontSize: 16.0),
                        ),
                        onPressed: () {
                          Beamer.of(context).beamToNamed('update-member-page', data: _member.toJson(), stacked: true);
                        }
                      ),
                    ],
                  ),
